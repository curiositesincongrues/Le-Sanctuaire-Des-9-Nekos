...
/* --- HUB --- */
function updateHeartBeat() { return window.HubModule.updateHeartBeat.apply(this, arguments); }

function enterHub() { return window.HubModule.enterHub.apply(this, arguments); }

function updateMikoBelt() { return window.HubModule.updateMikoBelt.apply(this, arguments); }

function showBeltTooltip() { return window.HubModule.showBeltTooltip.apply(this, arguments); }

function handleSlotClick() { return window.HubModule.handleSlotClick.apply(this, arguments); }

/* --- QR SCAN --- */
async function startScan() { return window.ScanModule.startScan.apply(this, arguments); }

function stopScan() { return window.ScanModule.stopScan.apply(this, arguments); }

function toggleTorch() { return window.ScanModule.toggleTorch.apply(this, arguments); }

function showManualEntry() { return window.ScanModule.showManualEntry.apply(this, arguments); }

function submitManualCode() { return window.ScanModule.submitManualCode.apply(this, arguments); }
...
/* --- ÉCRAN DE DÉCOUVERTE --- */
function showDiscoveryScreen() { return window.RevealModule.showDiscoveryScreen.apply(this, arguments); }

function winGame() { return window.RevealModule.winGame.apply(this, arguments); }

function animateSoulToHub() { return window.RevealModule.animateSoulToHub.apply(this, arguments); }

function setOutroMood() { return window.RevealModule.setOutroMood.apply(this, arguments); }
